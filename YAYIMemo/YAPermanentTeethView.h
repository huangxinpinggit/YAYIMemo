...
@protocol YAPermanentTeethViewDelegate <NSObject>
...
@interface YAPermanentTeethView : UIView
// maxillary  上颌
...
@property (nonatomic, weak)id <YAPermanentTeethViewDelegate>delegate;
