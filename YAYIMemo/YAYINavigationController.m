...
+ (void)initialize
{
    ...
    [bar setBackgroundImage:[UIImage  imageWithColor:YA_ALPHA_COLOR(255, 255, 255, 1.0)] forBarMetrics:UIBarMetricsDefault];
    ...
    bar.titleTextAttributes = @{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#424242"], NSFontAttributeName:[UIFont systemFontOfSize:YAYIFontWithScale(17)]};
...
- (void)viewDidLoad {
    ...
    [self dropShadowWithOffset:CGSizeMake(0, -0.5)
     ...
     //[[UINavigationBar appearance] setShadowImage:[UIImage imageWithColor:YAColor(@"#8a8a8a") size:CGSizeMake(SCREEN_W, 0.5)]];
